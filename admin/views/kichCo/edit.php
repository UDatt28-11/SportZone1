            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <?php endif; ?>
                        <!-- sửa -->
                        <form action="<?= BASE_URL_ADMIN . 'index.php?act=sua-kich-co' ?>" method="POST"
                            enctype="multipart/form-data">
                            <input type="hidden" name="id_kich_co" value="<?=$kichCo['id']?>">
                            <div class="row card-body ">
                                <div class="form-group col-12">
                                    <label>Tên kích cỡ</label>
                                    <input type="text" class="form-control" name="kich_co" value="<?=$kichCo['kich_co']?>"
