            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <?php endif; ?>
                        <!-- sửa -->
                        <form action="<?= BASE_URL_ADMIN . 'index.php?act=sua-mau-sac' ?>" method="POST"
                            enctype="multipart/form-data">
                            <input type="hidden" name="id_mau_sac" value="<?=$mau['id']?>">
                            <div class="row card-body ">
                                <div class="form-group col-12">
                                    <label>Tên màu sắc</label>
                                    <input type="text" class="form-control" name="mau_sac" value="<?=$mau['mau_sac']?>"
