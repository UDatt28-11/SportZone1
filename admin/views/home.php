                            ...
                            <div class="row">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-info">
                                        <div class="inner">
                                            <h3 _msttexthash="15587" _msthash="134"><?= $totalProducts ?></h3>

                                            <p _msttexthash="3258593" _msthash="135">Tổng số sản phẩm</p>
                                        </div>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        <div class="inner">
                                            ...
                                            <p _msttexthash="1984099" _msthash="138">Tổng số người dùng</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        <div class="inner">
                                            <h3 _msttexthash="10426" _msthash="143"><?= $totalOrders ?></h3>

                                            <p _msttexthash="4572321" _msthash="144">Đơn Hàng</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- ./col -->
                                    ...
                                    <div class="card">
                                        <div class="card-header ui-sortable-handle" style="cursor: move;">
                                            <h3 class="card-title">
                                                ...
                                                <font _mstmutation="1" _msttexthash="122395" _msthash="146"> Bán hàng
                                                </font>
                                            </h3>
                                                ...
                                                <ul class="nav nav-pills ml-auto">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#revenue-chart"
                                                            data-toggle="tab" _msttexthash="1194817" _msthash="147">Khu
                                                            vực</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="#sales-chart" data-toggle="tab"
                                                            _msttexthash="62400" _msthash="148">Donut</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- /.card-header -->
                                            ...
                                            <div class="tab-content p-0">
                                                ...
                                                <div class="chart tab-pane active" id="revenue-chart"
                                                    ...
                                                    <canvas id="revenue-chart-canvas" height="600"
                                                        style="height: 300px; display: block; width: 427px;" width="854"
                                    ...
                                    <div class="card bg-gradient-success">
                                        <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
                                            ...
                                            <h3 class="card-title">
                                                ...
                                                <font _mstmutation="1" _msttexthash="851851" _msthash="219"> Lịch
                                                </font>
                                            </h3>
                                            <!-- tools card -->
                                            <div class="card-tools" _msthidden="3">
                                                <!-- button with a dropdown -->
                                                <div class="btn-group" _msthidden="3">
                                                    <button type="button" class="btn btn-success btn-sm dropdown-toggle"
                                                        data-toggle="dropdown" data-offset="-52">
                                                        <i class="fas fa-bars"></i>
                                                    </button>
                                                    <div class="dropdown-menu" role="menu" _msthidden="3">
                                                        <a href="#" class="dropdown-item" _msttexthash="182078"
                                                            _msthidden="1" _msthash="220">Add new event</a>
                                                        <a href="#" class="dropdown-item" _msttexthash="183131"
                                                            _msthidden="1" _msthash="221">Clear events</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a href="#" class="dropdown-item" _msttexthash="202319"
                                                            _msthidden="1" _msthash="222">View calendar</a>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="datepicker-days" style="">
                                                                    <table class="table table-sm">
                                                                        <thead>
                                                                            ...
                                                                            <tr>
                                                                                <th class="dow" _msttexthash="19721"
                                                                                    _msthash="224">Su</th>
                                                                                <th class="dow" _msttexthash="18551"
                                                                                    _msthash="225">Mo</th>
                                                                                <th class="dow" _msttexthash="19812"
                                                                                    _msthash="226">Tu</th>
                                                                                <th class="dow" _msttexthash="109681"
                                                                                    _msthash="227">Chúng ta</th>
                                                                                <th class="dow" _msttexthash="18460"
                                                                                    _msthash="228">Th</th>
                                                                                <th class="dow" _msttexthash="18226"
                                                                                    _msthash="229">Fr</th>
                                                                                <th class="dow" _msttexthash="17641"
                                                                                    _msthash="230">Sa</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    ...
                                                                                    _msttexthash="9633" _msthash="231">
                                                                                    30</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="03/31/2025"
                                                                                    class="day old" _msttexthash="9737"
                                                                                    _msthash="232">31</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/01/2025" class="day"
                                                                                    _msttexthash="4459" _msthash="233">1
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/02/2025" class="day"
                                                                                    _msttexthash="4550" _msthash="234">2
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/03/2025" class="day"
                                                                                    _msttexthash="4641" _msthash="235">3
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/04/2025" class="day"
                                                                                    _msttexthash="4732" _msthash="236">4
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/05/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="4823" _msthash="237">5
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/06/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="4914" _msthash="238">6
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/07/2025" class="day"
                                                                                    _msttexthash="5005" _msthash="239">7
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/08/2025" class="day"
                                                                                    _msttexthash="5096" _msthash="240">8
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/09/2025" class="day"
                                                                                    _msttexthash="5187" _msthash="241">9
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/10/2025" class="day"
                                                                                    _msttexthash="9451" _msthash="242">
                                                                                    10</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/11/2025" class="day"
                                                                                    _msttexthash="9555" _msthash="243">
                                                                                    11</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/12/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="9659" _msthash="244">
                                                                                    12</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/13/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="9763" _msthash="245">
                                                                                    13</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/14/2025"
                                                                                    class="day active today"
                                                                                    _msttexthash="9867" _msthash="246">
                                                                                    14</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/15/2025" class="day"
                                                                                    _msttexthash="9971" _msthash="247">
                                                                                    15</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/16/2025" class="day"
                                                                                    _msttexthash="10075" _msthash="248">
                                                                                    16</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/17/2025" class="day"
                                                                                    _msttexthash="10179" _msthash="249">
                                                                                    17</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/18/2025" class="day"
                                                                                    _msttexthash="10283" _msthash="250">
                                                                                    18</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/19/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="10387" _msthash="251">
                                                                                    19</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/20/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="9542" _msthash="252">
                                                                                    20</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/21/2025" class="day"
                                                                                    _msttexthash="9646" _msthash="253">
                                                                                    21</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/22/2025" class="day"
                                                                                    _msttexthash="9750" _msthash="254">
                                                                                    22</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/23/2025" class="day"
                                                                                    _msttexthash="9854" _msthash="255">
                                                                                    23</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/24/2025" class="day"
                                                                                    _msttexthash="9958" _msthash="256">
                                                                                    24</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/25/2025" class="day"
                                                                                    _msttexthash="10062" _msthash="257">
                                                                                    25</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/26/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="10166" _msthash="258">
                                                                                    26</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/27/2025"
                                                                                    class="day weekend"
                                                                                    _msttexthash="10270" _msthash="259">
                                                                                    27</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/28/2025" class="day"
                                                                                    _msttexthash="10374" _msthash="260">
                                                                                    28</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/29/2025" class="day"
                                                                                    _msttexthash="10478" _msthash="261">
                                                                                    29</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="04/30/2025" class="day"
                                                                                    _msttexthash="9633" _msthash="262">
                                                                                    30</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/01/2025"
                                                                                    class="day new" _msttexthash="4459"
                                                                                    _msthash="263">1</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/02/2025"
                                                                                    class="day new" _msttexthash="4550"
                                                                                    _msthash="264">2</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/03/2025"
                                                                                    class="day new weekend"
                                                                                    _msttexthash="4641" _msthash="265">3
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/04/2025"
                                                                                    class="day new weekend"
                                                                                    _msttexthash="4732" _msthash="266">4
                                                                                </td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/05/2025"
                                                                                    class="day new" _msttexthash="4823"
                                                                                    _msthash="267">5</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/06/2025"
                                                                                    class="day new" _msttexthash="4914"
                                                                                    _msthash="268">6</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/07/2025"
                                                                                    class="day new" _msttexthash="5005"
                                                                                    _msthash="269">7</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/08/2025"
                                                                                    class="day new" _msttexthash="5096"
                                                                                    _msthash="270">8</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/09/2025"
                                                                                    class="day new" _msttexthash="5187"
                                                                                    _msthash="271">9</td>
                                                                                <td data-action="selectDay"
                                                                                    data-day="05/10/2025"
                                                                                    class="day new weekend"
                                                                                    _msttexthash="9451" _msthash="272">
                                                                                    10</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                <div class="datepicker-months" _msthidden="13"
                                                                    style="display: none;">
                                                                    <table class="table-condensed" _msthidden="13">
                                                                        <thead _msthidden="1">
                                                                            <tr _msthidden="1">
                                                                                <th class="prev" data-action="previous">
                                                                                    <span class="fa fa-chevron-left"
                                                                                ...
                                                                                <th class="picker-switch"
                                                                                    ...
                                                                                    _msttexthash="22282" _msthidden="1"
                                                                                    _msthash="273">2025</th>
                                                                                <th class="next" data-action="next">
                                                                                    <span class="fa fa-chevron-right"
                                                                        ...
                                                                        <tbody _msthidden="12">
                                                                            <tr _msthidden="12">
                                                                                <td colspan="7" _msthidden="12"><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="29692"
                                                                                        _msthidden="1"
                                                                                        _msthash="274">Jan</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="28340"
                                                                                        _msthidden="1"
                                                                                        _msthash="275">Feb</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="30433"
                                                                                        _msthidden="1"
                                                                                        _msthash="276">Mar</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month active"
                                                                                        _msttexthash="30901"
                                                                                        _msthidden="1"
                                                                                        _msthash="277">Apr</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="31252"
                                                                                        _msthidden="1"
                                                                                        _msthash="278">May</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="31772"
                                                                                        _msthidden="1"
                                                                                        _msthash="279">Jun</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="31538"
                                                                                        _msthidden="1"
                                                                                        _msthash="280">Jul</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="30134"
                                                                                        _msthidden="1"
                                                                                        _msthash="281">Aug</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="31161"
                                                                                        _msthidden="1"
                                                                                        _msthash="282">Sep</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="31057"
                                                                                        _msthidden="1"
                                                                                        _msthash="283">Oct</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="32448"
                                                                                        _msthidden="1"
                                                                                        _msthash="284">Nov</span><span
                                                                                        data-action="selectMonth"
                                                                                        class="month"
                                                                                        _msttexthash="28275"
                                                                                        _msthidden="1"
                                                                                        _msthash="285">Dec</span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                <div class="datepicker-years" _msthidden="13"
                                                                    style="display: none;">
                                                                    <table class="table-condensed" _msthidden="13">
                                                                        <thead _msthidden="1">
                                                                            <tr _msthidden="1">
                                                                                ...
                                                                                <th class="picker-switch"
                                                                                    ...
                                                                                    _msttexthash="64194" _msthidden="1"
                                                                                    _msthash="286">2020-2029</th>
                                                                                <th class="next" data-action="next">
                                                                                    <span class="fa fa-chevron-right"
                                                                        ...
                                                                        <tbody _msthidden="12">
                                                                            <tr _msthidden="12">
                                                                                <td colspan="7" _msthidden="12"><span
                                                                                        ...
                                                                                        _msttexthash="22685"
                                                                                        _msthidden="1"
                                                                                        _msthash="287">2019</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="21632"
                                                                                        _msthidden="1"
                                                                                        _msthash="288">2020</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="21762"
                                                                                        _msthidden="1"
                                                                                        _msthash="289">2021</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="21892"
                                                                                        _msthidden="1"
                                                                                        _msthash="290">2022</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22022"
                                                                                        _msthidden="1"
                                                                                        _msthash="291">2023</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22152"
                                                                                        _msthidden="1"
                                                                                        _msthash="292">2024</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year active"
                                                                                        _msttexthash="22282"
                                                                                        _msthidden="1"
                                                                                        _msthash="293">2025</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22412"
                                                                                        _msthidden="1"
                                                                                        _msthash="294">2026</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22542"
                                                                                        _msthidden="1"
                                                                                        _msthash="295">2027</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22672"
                                                                                        _msthidden="1"
                                                                                        _msthash="296">2028</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year"
                                                                                        _msttexthash="22802"
                                                                                        _msthidden="1"
                                                                                        _msthash="297">2029</span><span
                                                                                        data-action="selectYear"
                                                                                        class="year old"
                                                                                        _msttexthash="21749"
                                                                                        _msthidden="1"
                                                                                        _msthash="298">2030</span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                                <div class="datepicker-decades" _msthidden="13"
                                                                    style="display: none;">
                                                                    <table class="table-condensed" _msthidden="13">
                                                                        <thead _msthidden="1">
                                                                            <tr _msthidden="1">
                                                                                ...
                                                                                <th class="picker-switch"
                                                                                    data-action="pickerSwitch"
                                                                                    colspan="5" _msttexthash="63479"
                                                                                    _msthidden="1" _msthash="299">
                                                                                    2000-2090</th>
                                                                                <th class="next" data-action="next">
                                                                                    <span class="fa fa-chevron-right"
                                                                        ...
                                                                        <tbody _msthidden="12">
                                                                            <tr _msthidden="12">
                                                                                <td colspan="7" _msthidden="12"><span
                                                                                        ...
                                                                                        _msttexthash="23296"
                                                                                        _msthidden="1"
                                                                                        _msthash="300">1990</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2006"
                                                                                        _msttexthash="21398"
                                                                                        _msthidden="1"
                                                                                        _msthash="301">2000</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2016"
                                                                                        _msttexthash="21515"
                                                                                        _msthidden="1"
                                                                                        _msthash="302">2010</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade active"
                                                                                        data-selection="2026"
                                                                                        _msttexthash="21632"
                                                                                        _msthidden="1"
                                                                                        _msthash="303">2020</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2036"
                                                                                        _msttexthash="21749"
                                                                                        _msthidden="1"
                                                                                        _msthash="304">2030</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2046"
                                                                                        _msttexthash="21866"
                                                                                        _msthidden="1"
                                                                                        _msthash="305">2040</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2056"
                                                                                        _msttexthash="21983"
                                                                                        _msthidden="1"
                                                                                        _msthash="306">2050</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2066"
                                                                                        _msttexthash="22100"
                                                                                        _msthidden="1"
                                                                                        _msthash="307">2060</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2076"
                                                                                        _msttexthash="22217"
                                                                                        _msthidden="1"
                                                                                        _msthash="308">2070</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2086"
                                                                                        _msttexthash="22334"
                                                                                        _msthidden="1"
                                                                                        _msthash="309">2080</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade"
                                                                                        data-selection="2096"
                                                                                        _msttexthash="22451"
                                                                                        _msthidden="1"
                                                                                        _msthash="310">2090</span><span
                                                                                        data-action="selectDecade"
                                                                                        class="decade old"
                                                                                        data-selection="2106"
                                                                                        _msttexthash="21502"
                                                                                        _msthidden="1"
                                                                                        _msthash="311">2100</span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                    ...
                                    <div class="card bg-gradient-primary">
                                        <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
                                            <h3 class="card-title">
                                                ...
                                                <font _mstmutation="1" _msttexthash="1307072" _msthash="210"> Truy cập
                                                </font>
                                            </h3>
                                            <!-- card tools -->
                                            <div class="card-tools">
                                        ...
                                        <div class="card-body">
                                            <div id="world-map"
                                                ...
                                                <svg width="393.325" height="250">
                                                    <g
                                                        transform="scale(0.410140771637122) translate(0, 8.273406216233413)">
                                                        <path
                                                            ...
                                                            original="#f4f3f0" id="jqvmap1_hi" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ak" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_fl" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nh" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_mi" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_vt" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_me" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ri" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ny" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_pa" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nj" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_de" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_md" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_va" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_wv" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_oh" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_in" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_il" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ct" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_wi" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nc" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="m803.44,248.16c2.67,3.43 3.85,-1.02 0.55,-0.75l-0.29,0.4 -0.25,0.35z"
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_dc" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ma" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_tn" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ar" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_mo" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ga" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_sc" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ky" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_al" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_la" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ms" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ia" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_mn" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ok" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_tx" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nm" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ks" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ne" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_sd" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nd" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_wy" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_mt" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_co" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_id" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ut" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_az" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_nv" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_or" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_wa" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                                            original="#f4f3f0" id="jqvmap1_ca" class="jqvmap-region">
                                                        </path>
                                                    </g>
                                                </svg>
                                                <div class="jqvmap-zoomin">+</div>
                                                <div class="jqvmap-zoomout" _msttexthash="793702" _msthash="211">−</div>
                                            </div>
                                        </div>
                                        <!-- /.card-body-->
                                        <div class="card-footer bg-transparent">
                                            <div class="row">
                                                <div class="col-4 text-center">
                                                    ...
                                                    <div class="text-white" _msttexthash="1307072" _msthash="212">Truy
                                                        cập</div>
                                                </div>
                                                <!-- ./col -->
                                                <div class="col-4 text-center">
                                                    <div id="sparkline-2"><canvas width="100" height="62"
                                                            style="width: 80px; height: 50px;"></canvas></div>
                                                    <div class="text-white" _msttexthash="2468388" _msthash="213">Trực
                                                        tuyến</div>
                                                </div>
                                                <!-- ./col -->
                                                <div class="col-4 text-center">
                                                    <div id="sparkline-3"><canvas width="100" height="62"
                                                            style="width: 80px; height: 50px;"></canvas></div>
                                                    <div class="text-white" _msttexthash="122395" _msthash="214">Bán
                                                        hàng</div>
                                                </div>
                                                <!-- ./col -->
                                            </div>
                                    ...
                                    <div class="card bg-gradient-info">
                                        <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
                                            <h3 class="card-title">
                                                ...
                                                <font _mstmutation="1" _msttexthash="2424825" _msthash="215"> Biểu đồ
                                                    bán hàng </font>
                                            </h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <canvas class="chart chartjs-render-monitor" id="line-chart"
                                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 289px;"
                                                width="578" height="500"></canvas>
                                        </div>
                                        <!-- /.card-body -->
                                        <div class="card-footer bg-transparent">
                                            <div class="row">
                                                <div class="col-4 text-center">
                                                    <div style="display:inline;width:60px;height:60px;"><canvas
                                                            width="75" height="75"
                                                            style="width: 60px; height: 60px;"></canvas><input
                                                    ...
                                                    <div class="text-white" _msttexthash="1156428" _msthash="216">Đặt
                                                        hàng qua thư</div>
                                                </div>
                                                <!-- ./col -->
                                                <div class="col-4 text-center">
                                                    ...
                                                    <div class="text-white" _msttexthash="2468388" _msthash="217">Trực
                                                        tuyến</div>
                                                </div>
                                                <!-- ./col -->
                                                <div class="col-4 text-center">
                                                    ...
                                                    <div class="text-white" _msttexthash="1547871" _msthash="218">Trong
                                                        cửa hàng</div>
                                                </div>
                                                <!-- ./col -->
                                            </div>
