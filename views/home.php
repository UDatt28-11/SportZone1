...
<!-- Mirrored from anvogue-html.vercel.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Mar 2025 09:34:00 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="shortcut icon" href="/SportZone1/assets/images/fav.png" type="image/x-icon" />
    <link rel="stylesheet" href="/SportZone1/assets/css/swiper-bundle.min.css" />
    <link rel="stylesheet" href="/SportZone1/assets/css/style.css" />
    <link rel="stylesheet" href="/SportZone1/assets/dist/output-scss.css" />
    <link rel="stylesheet" href="/SportZone1/assets/dist/output-tailwind.css" />
</head>
...
<body>
    <div id="top-nav" class="top-nav style-one bg-black md:h-[44px] h-[30px]">
        <div class="container mx-auto h-full">
            <div class="top-nav-main flex justify-between max-md:justify-center h-full">
                ...
                <div class="text-center text-button-uppercase text-white flex items-center">New customers save 10% with
                    the code GET10</div>
                            ...
                            <ul class="flex items-center gap-8 h-full">
                                <li class="h-full relative">
                                    <a href="#!"
                                        ...
                                        Demo </a>
                                    <div
                                        class="sub-menu py-3 px-5 -left-10 w-max absolute grid grid-cols-4 gap-5 bg-white rounded-b-xl">
                                        <ul>
                                            <li>
                                                <a href="index-2.html" class="link text-secondary duration-300 active">
                                                    Home Fashion 1 </a>
                                            </li>
                                            <li>
                                                <a href="fashion2.html" class="link text-secondary duration-300"> Home
                                                    Fashion 2 </a>
                                            </li>
                                            <li>
                                                <a href="fashion3.html" class="link text-secondary duration-300"> Home
                                                    Fashion 3 </a>
                                            </li>
                                            <li>
                                                <a href="fashion4.html" class="link text-secondary duration-300"> Home
                                                    Fashion 4 </a>
                                            </li>
                                            <li>
                                                <a href="fashion5.html" class="link text-secondary duration-300"> Home
                                                    Fashion 5 </a>
                                            </li>
                                            <li>
                                                <a href="fashion6.html" class="link text-secondary duration-300"> Home
                                                    Fashion 6 </a>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <a href="fashion7.html" class="link text-secondary duration-300"> Home
                                                    Fashion 7 </a>
                                            </li>
                                            <li>
                                                <a href="fashion8.html" class="link text-secondary duration-300"> Home
                                                    Fashion 8 </a>
                                            </li>
                                            <li>
                                                <a href="fashion9.html" class="link text-secondary duration-300"> Home
                                                    Fashion 9 </a>
                                            </li>
                                            <li>
                                                <a href="fashion10.html" class="link text-secondary duration-300"> Home
                                                    Fashion 10 </a>
                                            </li>
                                            <li>
                                                <a href="fashion11.html" class="link text-secondary duration-300"> Home
                                                    Fashion 11 </a>
                                            </li>
                                            <li>
                                                <a href="underwear.html" class="link text-secondary duration-300"> Home
                                                    Underwear </a>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <a href="cosmetic1.html" class="link text-secondary duration-300"> Home
                                                    Cosmetic 1 </a>
                                            </li>
                                            <li>
                                                <a href="cosmetic2.html" class="link text-secondary duration-300"> Home
                                                    Cosmetic 2 </a>
                                            </li>
                                            <li>
                                                <a href="cosmetic3.html" class="link text-secondary duration-300"> Home
                                                    Cosmetic 3 </a>
                                            </li>
                                            <li>
                                                <a href="pet.html" class="link text-secondary duration-300"> Home Pet
                                                    Store </a>
                                            </li>
                                            <li>
                                                <a href="jewelry.html" class="link text-secondary duration-300"> Home
                                                    Jewelry </a>
                                            </li>
                                            <li>
                                                <a href="furniture.html" class="link text-secondary duration-300"> Home
                                                    Furniture </a>
                                            </li>
                                        </ul>
                                        <ul>
                                            <li>
                                                <a href="watch.html" class="link text-secondary duration-300"> Home
                                                    Watch </a>
                                            </li>
                                            <li>
                                                <a href="toys.html" class="link text-secondary duration-300"> Home Toys
                                                    Kid </a>
                                            </li>
                                            <li>
                                                <a href="yoga.html" class="link text-secondary duration-300"> Home Yoga
                                                </a>
                                            </li>
                                            <li>
                                                <a href="organic.html" class="link text-secondary duration-300"> Home
                                                    Organic </a>
                                            </li>
                                            <li>
                                                <a href="marketplace.html" class="link text-secondary duration-300">
                                                    Home Marketplace </a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="container">
                                            <div class="flex justify-between py-8">
                                                ...
                                                <div class="banner-ads-block pl-2.5 basis-1/3">
                                                    <a href="shop-breadcrumb1.html"
                                                        class="banner-ads-item bg-linear rounded-2xl relative block overflow-hidden cursor-pointer">
                                                        <div class="text-content py-14 pl-8 relative z-[1]">
                                                            <div
                                                                ...
                                                                Save $10</div>
                                                            <div class="heading6 mt-2">Dive into Savings <br />on
                                                                Swimwear</div>
                                                            <div class="body1 mt-3 text-secondary">Starting at <span
                                                                    class="text-red">$59.99</span></div>
                                                        </div>
                                                        <img src="./assets/images/slider/bg2-2.png" alt="bg-img"
                                                            class="h-full w-auto absolute right-0 top-0 duration-700" />
                                                    </a>
                                                    <a href="shop-breadcrumb1.html"
                                                        class="banner-ads-item bg-linear rounded-2xl relative block overflow-hidden cursor-pointer mt-8">
                                                        <div class="text-content py-14 pl-8 relative z-[1]">
                                                            <div
                                                                class="text-button-uppercase text-white bg-red px-2 py-0.5 inline-block rounded-sm">
                                                                Save $10</div>
                                                        ...
                                                        <img src="./assets/images/other/bg-feature.png" alt="bg-img"
                                                            class="h-full w-auto absolute right-0 top-0 duration-700" />
                                                    </a>
                                                </div>
                                            </div>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="checkout.html"
                                                                    class="link text-secondary duration-300"> Checkout
                                                                </a>
                                                            </li>
                                                            <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="wishlist.html"
                                                                    class="link text-secondary duration-300"> Wish List
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="search-result.html"
                                                                    class="link text-secondary duration-300"> Search
                                                                    Result </a>
                                                            </li>
                                                            <li>
                                                                <a href="cart.html"
                                                                    class="link text-secondary duration-300"> Shopping
                                                                    Cart </a>
                                                            </li>
                                                            <li>
                                                                <a href="login.html"
                                                            ...
                                                            <li>
                                                                <a href="order-tracking.html"
                                                                    class="link text-secondary duration-300"> Order
                                                                    Tracking </a>
                                                            </li>
                                                            <li>
                                        ...
                                        <ul class="w-full">
                                            ...
                                            <li>
                                                <a href="customer-feedbacks.html"
                                                    class="link text-secondary duration-300"> Customer Feedbacks </a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                            ...
                                            <div class="nav-link grid grid-cols-2 gap-5 gap-y-6 justify-between">
                                                ...
                                                <div class="nav-item">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="checkout.html"
                                                                class="link text-secondary duration-300"> Checkout </a>
                                                        </li>
                                                        <li>
                                                            <a href="checkout2.html"
                                                                class="link text-secondary duration-300"> Checkout Style
                                                                2 </a>
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="slider-item h-full w-full relative">
                                <div class="container w-full h-full flex items-center relative">
                                    <div class="text-content basis-1/2">
                                        ...
                                        <a href="shop-breadcrumb-img.html" class="button-main md:mt-8 mt-3">Shop Now
                                        </a>
                                    </div>
                                    <div
                                        class="sub-img absolute sm:w-1/2 w-3/5 2xl:-right-[60px] -right-[16px] bottom-0">
                            ...
                            <div class="slider-item h-full w-full relative">
                                <div class="container w-full h-full flex items-center relative">
                                    ...
                                    <div
                                        ...
                                        <img src="./assets/images/slider/bg1-2.png" alt="bg1-2" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="menu-tab bg-surface rounded-2xl mt-6">
                    <div class="menu flex items-center gap-2 p-1">
                        ...
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black active"
                            data-item="t-shirt">t-shirt</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="dress">dress</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="sets">sets</div>
                        <div class="tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-300 hover:text-black"
                            data-item="shirt">shirt</div>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="menu-tab bg-surface rounded-2xl">
                    <div class="menu flex items-center gap-2 p-1">
                        ...
                        <div class="tab-item relative text-secondary heading5 py-2 px-5 cursor-pointer duration-500 hover:text-black active"
                            data-item="best sellers">best sellers</div>
                        <div class="tab-item relative text-secondary heading5 py-2 px-5 cursor-pointer duration-500 hover:text-black"
                            data-item="on sale">on sale</div>
                        <div class="tab-item relative text-secondary heading5 py-2 px-5 cursor-pointer duration-500 hover:text-black"
                            data-item="new arrivals">new arrivals</div>
                    </div>
                </div>
            </div>
            <div
                            ...
                            <div class="testimonial-item style-one h-full">
                                <div class="testimonial-main bg-white p-8 rounded-2xl h-full">
                                    ...
                                    <div class="desc mt-2">"Fantastic shop! Great selection, fair prices, and friendly
                                        staff. Highly recommended. The quality of the products is exceptional, and the
                                        prices are very reasonable!"</div>
                            ...
                            <div class="testimonial-item style-one h-full">
                                <div class="testimonial-main bg-white p-8 rounded-2xl h-full">
                                    ...
                                    <div class="desc mt-2">"Anvouge's fashion collection is a game-changer! Their unique
                                        and trendy pieces have completely transformed my style. It's comfortable,
                                        stylish, and always on-trend."</div>
                            ...
                            <div class="testimonial-item style-one h-full">
                                <div class="testimonial-main bg-white p-8 rounded-2xl h-full">
                                    ...
                                    <div class="desc mt-2">"I absolutely love this shop! The products are high-quality
                                        and the customer service is excellent. I always leave with exactly what I need
                                        and a smile on my face."</div>
                            ...
                            <div class="testimonial-item style-one h-full">
                                <div class="testimonial-main bg-white p-8 rounded-2xl h-full">
                                    ...
                                    <div class="desc mt-2">"I can't get enough of Anvouge's high-quality clothing. It's
                                        comfortable, stylish, and always on-trend. The products are high-quality and the
                                        customer service is excellent."</div>
                            ...
                            <div class="testimonial-item style-one h-full">
                                <div class="testimonial-main bg-white p-8 rounded-2xl h-full">
                                    ...
                                    <div class="desc mt-2">"I love this shop! The products are always top-quality, and
                                        the staff is incredibly friendly and helpful. They go out of their way to make
                                        sure that I'm satisfied my purchase."</div>
            ...
            <div class="modal-newsletter-main">
                <div class="main-content flex rounded-[20px] overflow-hidden w-full">
                    <div
                        ...
                        <div class="text-button-uppercase text-center">New customers save <span
                                class="text-red">30%</span> with the code</div>
                        <div class="text-button-uppercase text-red bg-white py-2 px-4 rounded-lg">GET20off</div>
                        <div class="button-main w-fit bg-black text-white hover:bg-white uppercase">Copy coupon code
                        </div>
                    </div>
                            ...
                            <div class="choose-color">
                                ...
                                <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                    ...
                                    <div class="color-item w-12 h-12 rounded-xl duration-300 relative">
                                        <img src="./assets/images/product/color/red.png" alt="color"
                                            class="rounded-xl" />
                                        <div
                                            class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">
                                            red</div>
    ...
    <script src="/SportZone1/assets/js/phosphor-icons.js"></script>
    <script src="/SportZone1/assets/js/swiper-bundle.min.js"></script>
    <script src="/SportZone1/assets/js/main.js"></script>
</body>

<!-- Mirrored from anvogue-html.vercel.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Mar 2025 09:34:10 GMT -->
