...
<div class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-500 md:ml-2"><?= $danhMucc['ten_danh_muc'] ?></span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <!-- Category Title -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold"><?= $danhMucc['ten_danh_muc'] ?></h1>
        <p class="text-gray-600 mt-2"><?= $danhMucc['mo_ta'] ?? '' ?></p>
    </div>
