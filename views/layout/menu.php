                    ...
                    <div class="list-action flex items-center gap-4">
                        ...
                        if (isset($_SESSION['user'])) {
                            ...
                            <div
                                ...
                                <a href="<?= BASE_URL . '?act=don-hang' ?>" class="button-main w-full text-center">
                                    Đơn Hàng
                                </a><br><br>
                                <?php
                                ...
                                <a href="<?= BASE_URL . '?act=logout-client' ?>"
                                    ...
                                    class="button-main bg-white text-black border border-black w-full text-center">Đăng
                                    Xuất</a>
                                <?php } ?>
                ...
                <div class="modal-search-block">
                    <div class="modal-search-main md:p-10 p-6 rounded-[32px]">
                        <form action="<?= BASE_URL ?>?act=search" method="GET"
                            class="form-search relative w-full flex items-center gap-2">
                            ...
                            <button type="submit"
                                class="btn-search bg-black text-white px-6 py-3 rounded-2xl hover:bg-gray-800 transition-colors">
