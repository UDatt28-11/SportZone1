...
<div class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-500 md:ml-2">Kết quả tìm kiếm: "<?= htmlspecialchars($keyword) ?>"</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <!-- Search Results -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold">Kết quả tìm kiếm</h1>
        <p class="text-gray-600 mt-2">Tìm thấy <?= count($sanPhams) ?> sản phẩm</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="price">
                                <?php if($sanPham['gia_khuyen_mai']): ?>
                                    ...
                                    <span class="text-sm text-gray-500 line-through ml-2"><?= number_format($sanPham['gia_san_pham'], 0, ',', '.') ?>đ</span>
                                <?php else: ?>
                                    <span class="text-xl font-bold"><?= number_format($sanPham['gia_san_pham'], 0, ',', '.') ?>đ</span>
                                <?php endif; ?>
                            </div>
        ...
        <?php else: ?>
            <div class="col-span-full text-center py-8">
                <p class="text-gray-500">Không tìm thấy sản phẩm nào phù hợp với từ khóa "<?= htmlspecialchars($keyword) ?>"</p>
            </div>
        <?php endif; ?>
    </div>
</div>
